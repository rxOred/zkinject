...
zkelf::ElfObj<T>::ElfObj(void *map, std::size_t size,
    ...
    debug_line("calling elfobj consutructor");
...
zkelf::ZkElf::ZkElf(std::variant<std::shared_ptr<ElfObj<x64>>, std::shared_ptr<ElfObj<x86>>> obj,
                    std::variant<elf_read_only, elf_read_write> options,
                    std::optional<zklog::ZkLog *> log)
    : elf_file_options(options), elf_object(obj), elf_log(log) {
        debug_line("calling zkelf constructor");
    }
...
bool zkelf::ZkElf::load_symbol_data() {
    ...
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object))
        indexes = elf->get()->get_section_index_array();
    else {
        indexes = elf->get()->get_section_index_array();
    }
    try {
    ...
    auto init_symbol_structs = [&](auto &elf) {
        ...
        elf.get()->set_symbol_table(
            &map[elf.get()->get_section_header_table()[indexes[ELF_SYMTAB_INDEX]]
                     .sh_offset]);
        elf.get()->set_string_table(
            &map[elf.get()->get_section_header_table()[indexes[ELF_STRTAB_INDEX]]
                     .sh_offset]);
    };
...
bool zkelf::ZkElf::load_dynamic_data(void) {
    ...
    auto init_dynamic_symbol_structs = [&](auto &elf) {
        ...
        elf.get()->set_dynamic_section(
            &map[elf.get()->get_section_header_table()[indexes[ELF_DYNAMIC_INDEX]]
                     .sh_offset]);
        elf.get()->set_dynamic_symbol_table(
            &map[elf.get()->get_section_header_table()[indexes[ELF_DYNSYM_INDEX]]
                     .sh_offset]);
        // NOTE make sure dynsym.sh_link holds the index of the string
        // table
        indexes[ELF_DYNSTR_INDEX] =
            elf.get()->get_section_header_table()[indexes[ELF_DYNSYM_INDEX]]
                .sh_link;
        elf.get()->set_dynamic_string_table(
            &map[elf.get()->get_section_header_table()[indexes[ELF_DYNSTR_INDEX]]
                     .sh_offset]);
    };
...
void *zkelf::ZkElf::get_memory_map(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_memory_map();
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()->get_memory_map();
}

std::size_t zkelf::ZkElf::get_map_size(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_map_size();
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()->get_map_size();
}

bool zkelf::ZkElf::is_stripped(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->is_stripped();
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()->is_stripped();
}

void zkelf::ZkElf::set_stripped(void) {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->set_stripped(true);
    } else if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->set_stripped(true);
    }
}
...
zkelf::e_type zkelf::ZkElf::get_elf_type(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_type;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)
        ->get()
        ->get_elf_header()
        ->elf_type;
}
...
zkelf::e_machine zkelf::ZkElf::get_elf_machine(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_machine;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)
        ->get()
        ->get_elf_header()
...
zkelf::e_version zkelf::ZkElf::get_elf_version(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_version;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_version;
}
...
zktypes::u64_t zkelf::ZkElf::get_elf_entry_point(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_entry;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_entry;
...
zktypes::u64_t zkelf::ZkElf::get_elf_phdr_offset(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_phoff;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_phoff;
...
zktypes::u64_t zkelf::ZkElf::get_elf_shdr_offset(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_shoff;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_shoff;
...
zktypes::u32_t zkelf::ZkElf::get_elf_flags(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_flags;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_flags;
...
zktypes::u16_t zkelf::ZkElf::get_elf_header_size(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_ehsize;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_ehsize;
...
zktypes::u16_t zkelf::ZkElf::get_elf_phdr_entry_size(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_phentsize;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_phentsize;
...
zktypes::u16_t zkelf::ZkElf::get_elf_phdr_entry_count(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_phnum;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_phnum;
...
zktypes::u16_t zkelf::ZkElf::get_elf_shdr_entry_size(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_shentsize;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_shentsize;
...
zktypes::u16_t zkelf::ZkElf::get_elf_shdr_entry_count(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_shnum;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_shnum;
...
zktypes::u16_t zkelf::ZkElf::get_elf_shdr_string_table_index(void) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_elf_header()->elf_shstrndx;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_elf_header()
        ->elf_shstrndx;
...
zktypes::u32_t zkelf::ZkElf::get_section_name_index(int shdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_section_header_table()[shdr_index].sh_name;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
...
zkelf::s_type zkelf::ZkElf::get_section_type(int shdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_section_header_table()[shdr_index].sh_type;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_section_header_table()[shdr_index]
        .sh_type;
...
zktypes::u64_t zkelf::ZkElf::get_section_flags(int shdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_section_header_table()[shdr_index].sh_flags;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_section_header_table()[shdr_index]
        .sh_flags;
...
zktypes::u64_t zkelf::ZkElf::get_section_address(int shdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_section_header_table()[shdr_index].sh_addr;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_section_header_table()[shdr_index]
        .sh_addr;
...
zktypes::u64_t zkelf::ZkElf::get_section_offset(int shdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_section_header_table()[shdr_index].sh_offset;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_section_header_table()[shdr_index]
        .sh_offset;
...
zktypes::u64_t zkelf::ZkElf::get_section_size(int shdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_section_header_table()[shdr_index].sh_size;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_section_header_table()[shdr_index]
        .sh_size;
...
zktypes::u64_t zkelf::ZkElf::get_section_address_alignment(
    ...
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_section_header_table()[shdr_index].sh_addralign;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_section_header_table()[shdr_index]
        .sh_addralign;
...
zktypes::u64_t zkelf::ZkElf::get_section_entry_size(int shdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_section_header_table()[shdr_index].sh_entsize;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_section_header_table()[shdr_index]
        .sh_entsize;
...
zktypes::u32_t zkelf::ZkElf::get_section_link(int shdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_section_header_table()[shdr_index].sh_link;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_section_header_table()[shdr_index]
        .sh_link;
...
zktypes::u32_t zkelf::ZkElf::get_section_info(int shdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_section_header_table()[shdr_index].sh_info;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_section_header_table()[shdr_index]
        .sh_info;
...
zkelf::p_type zkelf::ZkElf::get_segment_type(int phdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_program_header_table()[phdr_index].ph_type;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
...
zktypes::u64_t zkelf::ZkElf::get_segment_offset(int phdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_program_header_table()[phdr_index].ph_offset;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_program_header_table()[phdr_index]
        .ph_offset;
...
zktypes::u64_t zkelf::ZkElf::get_segment_vaddress(int phdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_program_header_table()[phdr_index].ph_vaddr;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_program_header_table()[phdr_index]
        .ph_vaddr;
...
zktypes::u64_t zkelf::ZkElf::get_segment_paddress(int phdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_program_header_table()[phdr_index].ph_paddr;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_program_header_table()[phdr_index]
        .ph_paddr;
...
zktypes::u32_t zkelf::ZkElf::get_segment_flags(int phdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_program_header_table()[phdr_index].ph_flags;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_program_header_table()[phdr_index]
        .ph_flags;
...
zktypes::u64_t zkelf::ZkElf::get_segment_file_size(int phdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_program_header_table()[phdr_index].ph_filesz;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_program_header_table()[phdr_index]
        .ph_filesz;
...
zktypes::u64_t zkelf::ZkElf::get_segment_memory_size(
    ...
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_program_header_table()[phdr_index].ph_memsz;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_program_header_table()[phdr_index]
        .ph_memsz;
...
zktypes::u64_t zkelf::ZkElf::get_segment_address_alignment(
    int phdr_index) const {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        return elf->get()->get_program_header_table()[phdr_index].ph_align;
    }
    return std::get_if<std::shared_ptr<ElfObj<x86>>>(&elf_object)->get()
        ->get_program_header_table()[phdr_index]
        .ph_align;
...
int zkelf::ZkElf::get_section_index_by_name(const char *section_name) {
    auto compare_section_names = [&,
        ...
        if (elf.get()->is_stripped()) {
            ...
            auto elfheader = elf.get()->get_elf_header();
            auto shdrtab = elf.get()->get_section_header_table();
            for (std::size_t i = 0; i < elfheader->elf_shnum; ++i) {
                if (!strcmp(&elf.get()->get_section_header_string_table()
                                 [shdrtab[i].sh_name],
                            section_name)) {
                    return i;
                }
...
int zkelf::ZkElf::get_segment_index_by_attr(zkelf::p_type type,
    ...
    auto compare_segment_attributes = [&](const auto &elf) -> int {
        auto phdrtab = elf.get()->get_program_header_table();
...
int zkelf::ZkElf::get_symbol_index_by_name(const char *symbol_name) {
    auto compare_symbol_name = [&](auto &elf) -> int {
        if (elf.get()->get_section_index_array()[ELF_SYMTAB_INDEX] == 0 ||
            elf.get()->get_section_index_array()[ELF_STRTAB_INDEX] == 0) {
            return -1;  // bad ret
        }
        auto shdrtab = elf.get()->get_section_header_table();
        auto symtab = elf.get()->get_symbol_table();
        auto strtab = elf.get()->get_string_table();
        for (auto i = 0;
             i <
             shdrtab[elf.get()->get_section_index_array()[ELF_SYMTAB_INDEX]]
                     .sh_size /
                 shdrtab[elf.get()->get_section_index_array()[ELF_SYMTAB_INDEX]]
                     .sh_entsize;
             ++i) {
...
int zkelf::ZkElf::get_dynamic_symbol_index_by_name(
    ...
    auto compare_symbol_name = [&](auto &elf) -> int {
        if (elf.get()->get_section_index_array()[ELF_DYNSTR_INDEX] == 0 ||
            elf.get()->get_section_index_array()[ELF_DYNSTR_INDEX] == 0) {
            return -1;  // TODO bad ret
        }
        auto shdrtab = elf.get()->get_section_header_table();
        auto dynsym = elf.get()->get_dynamic_symbol_table();
        auto dynstr = elf.get()->get_dynamic_string_table();
        for (auto i = 0;
             i <
             shdrtab[elf.get()->get_section_index_array()[ELF_DYNSYM_INDEX]]
                     .sh_size /
                 shdrtab[elf.get()->get_section_index_array()[ELF_DYNSYM_INDEX]]
                     .sh_entsize;
             ++i) {
...
void zkelf::ZkElf::set_elf_type(e_type new_type) {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_elf_header()->elf_type = new_type;
    } else { 
        elf->get()->get_elf_header()->elf_type = new_type;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_elf_machine(e_machine new_machine) {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_elf_header()->elf_machine = new_machine;
    } else  {
        elf->get()->get_elf_header()->elf_machine = new_machine;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_elf_version(e_version new_version) {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_elf_header()->elf_version = new_version;
    } else  {
        elf->get()->get_elf_header()->elf_version = new_version;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_elf_flags(zktypes::u32_t new_flags) {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_elf_header()->elf_flags = new_flags;
    } else {
        elf->get()->get_elf_header()->elf_flags = new_flags;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_elf_phdr_entry_count(zktypes::u16_t new_count) {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_elf_header()->elf_phnum = new_count;
    } else {
        elf->get()->get_elf_header()->elf_phnum = new_count;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_elf_shdr_entry_count(zktypes::u16_t new_count) {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_elf_header()->elf_shnum = new_count;
    } else {
        elf->get()->get_elf_header()->elf_shnum = new_count;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_elf_shdr_string_table_index(
    ...
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_elf_header()->elf_shstrndx = new_index;
    } else  {
        elf->get()->get_elf_header()->elf_shstrndx = new_index;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_section_name_index(int shdr_index,
    ...
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_section_header_table()[shdr_index].sh_name = new_index;
    } else {
        elf->get()->get_section_header_table()[shdr_index].sh_name = new_index;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_section_type(int shdr_index, s_type new_type) {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_section_header_table()[shdr_index].sh_type = new_type;
    } else {
        elf->get()->get_section_header_table()[shdr_index].sh_type = new_type;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_section_link(int shdr_index,
    ...
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_section_header_table()[shdr_index].sh_link = new_link;
    } else {
        elf->get()->get_section_header_table()[shdr_index].sh_link = new_link;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_section_info(int shdr_index,
    ...
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_section_header_table()[shdr_index].sh_info = new_info;
    } else {
        elf->get()->get_section_header_table()[shdr_index].sh_info = new_info;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_segment_type(int phdr_index, p_type new_type) {
    if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
        elf->get()->get_program_header_table()[phdr_index].ph_type = new_type;
    } else {
        elf->get()->get_program_header_table()[phdr_index].ph_type = new_type;
    }
    CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_segment_flags(int phdr_index,
	...
	if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
		elf->get()->get_program_header_table()[phdr_index].ph_flags = new_flags;
	} else {
		elf->get()->get_program_header_table()[phdr_index].ph_flags = new_flags;
	}
	CHECKFLAGS_AND_SAVE
...
void zkelf::ZkElf::set_segment_file_size(int phdr_index, uint new_filesz) {
	if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
		elf->get()->get_program_header_table()[phdr_index].ph_filesz =
...
void zkelf::ZkElf::set_segment_memory_size(int phdr_index, uint new_memsz) {
	if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
		elf->get()->get_program_header_table()[phdr_index].ph_memsz =
			x64::u64_t(new_memsz);
	} else {
		elf->get()->get_program_header_table()[phdr_index].ph_memsz =
			x86::u32_t(new_memsz);
...
void zkelf::ZkElf::set_segment_alignment(int phdr_index, uint new_alignment) {
	if (auto elf = std::get_if<std::shared_ptr<ElfObj<x64>>>(&elf_object)) {
		elf
			->get()->get_program_header_table()[phdr_index]
...
void *zkelf::ZkElf::elf_read(off_t read_offset,
    ...
    auto e_read = [&read_offset, &size](const auto &elf) -> void * {
        zktypes::u8_t *map = (zktypes::u8_t *)elf.get()->get_memory_map();
        zktypes::u8_t *buffer =
...
void zkelf::ZkElf::save_source() const noexcept {
    if (auto elf = std::get_if<std::shared_ptr<zkelf::ElfObj<x64>>>(&elf_object)) {
        std::visit(save{elf->get()->get_memory_map(), elf->get()->get_map_size()},
                   elf->get()->get_elf_source());
    } else {
        std::visit(save{elf->get()->get_memory_map(), elf->get()->get_map_size()},
                   elf->get()->get_elf_source());
    }
